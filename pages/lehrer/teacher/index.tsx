      ...
      <Accordion>
        <AccordionTab header="Clases Programadas">
          <div className="col-12">
            <p>
              Tienes asignadas las siguientes clases, asiste puntualmente al lugar de la clase, en caso de algún inconveniente preguntale a tu
        ...
        <AccordionTab header="Llenar Reportes">
          <div className="col-12">
            <p>
              Con el fin de que los padres o acudientes esten actualizados de los avances de sus hijos, llena los siguientes reportes lo mas antes
              posible para que reciban tus observaciones y recomendaciones
            </p>
            <DataTable
              value={customers1}
              paginator
        ...
        <AccordionTab header="Solicitar Clase">
          <p>
            Tienes 6 horas despues de cada clase para indicar al coordinador o acudiente que autorice una nueva clase, en caso de haber pasado ese
            tiempo, solicitale al coordinador que te agende una clase ya conversada con el acudiente
          </p>
          <DataTable
            value={customers1}
            paginator
        ...
        <AccordionTab header="Clases Dictadas">
          <p>Selecciona el rango de fechas de las clases ya dictadas que deseas ver:</p>
