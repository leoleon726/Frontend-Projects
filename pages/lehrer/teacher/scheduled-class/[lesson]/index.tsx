...
import ClassLink from "@presentation/components/ClassLink";
      ...
      <div className={`flex flex-wrap gap-5 mt-5 ${styles.center_form}`}>
        ...
        >
          <div className="flex align-items-center justify-content-center">
            ...
            <span>
              Recuerda que esta acción puede afectar <b>NEGATIVAMENTE</b> a todo tu equipo. Estas seguro que deseas cancelar la clase?
            </span>
          </div>
        </Dialog>
      </div>
