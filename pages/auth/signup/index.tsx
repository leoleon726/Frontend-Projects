...
const SignUpPage: Page = () => {
  ...
  const handleSignup = async (e: any) => {
    e.preventDefault();
    try {
      await signup(data.email, data.password, data.name, data.lastname, data.conditions);
  ...
  return (
    <div className={containerClassName}>
      <div className="flex flex-column align-items-center justify-content-center">
        <Image
          src={layoutConfig.colorScheme === "light" ? logoDark : logoLight}
          alt="Lehrer Profesores Personalizados"
