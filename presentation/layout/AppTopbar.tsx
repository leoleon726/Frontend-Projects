...
import { AppTopbarRef } from "@utils/types/types";
  ...
  return (
    <div className="layout-topbar">
      <Link href="/" className="layout-topbar-logo">
        <Image src={layoutConfig.colorScheme === "light" ? logoDark : logoLight} width={47.22} height={35} alt="logo" />
        <span>Lehrer</span>
      </Link>
      ...
      >
        {user ? (
          <>
            <Menu ref={menu} model={loginItems} popup />
          ...
          <>
            <Menu ref={menu} model={notLoginItems} popup />
            <button type="button" className="p-link layout-topbar-button" onClick={toggleMenu}>
              <i className="pi pi-user"></i>
              <span>Profile</span>
            </button>
